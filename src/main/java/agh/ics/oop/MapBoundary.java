...
public class MapBoundary implements IPositionChangeObserver{
    private final TreeSet<Vector2d> xOrder = new TreeSet<>(Comparator.comparingInt(v -> v.x));
    private final TreeSet<Vector2d> yOrder = new TreeSet<>(Comparator.comparingInt(v -> v.y));
